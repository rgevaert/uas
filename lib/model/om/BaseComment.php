...
abstract class BaseComment extends BaseObject  implements Persistent {
	...
	public function setIsPublic($v)
	{
		...
		if ($this->is_public !== $v || $this->isNew()) {
			$this->is_public = $v;
			$this->modifiedColumns[] = CommentPeer::IS_PUBLIC;
		}
	...
	public function setIsActivated($v)
	{
		...
		if ($this->is_activated !== $v || $this->isNew()) {
			$this->is_activated = $v;
			$this->modifiedColumns[] = CommentPeer::IS_ACTIVATED;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->is_activated = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CommentPeer::IS_PUBLIC)) $criteria->add(CommentPeer::IS_PUBLIC, $this->is_public);
		if ($this->isColumnModified(CommentPeer::IS_ACTIVATED)) $criteria->add(CommentPeer::IS_ACTIVATED, $this->is_activated);
