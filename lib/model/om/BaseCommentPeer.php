...
abstract class BaseCommentPeer {
	...
	const IS_PUBLIC = 'comment.IS_PUBLIC';

	/** the column name for the IS_ACTIVATED field */
	const IS_ACTIVATED = 'comment.IS_ACTIVATED';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Subject', 'Message', 'IsPublic', 'IsActivated', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'subject', 'message', 'isPublic', 'isActivated', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::SUBJECT, self::MESSAGE, self::IS_PUBLIC, self::IS_ACTIVATED, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'subject', 'message', 'is_public', 'is_activated', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Subject' => 2, 'Message' => 3, 'IsPublic' => 4, 'IsActivated' => 5, 'CreatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'subject' => 2, 'message' => 3, 'isPublic' => 4, 'isActivated' => 5, 'createdAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::SUBJECT => 2, self::MESSAGE => 3, self::IS_PUBLIC => 4, self::IS_ACTIVATED => 5, self::CREATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'subject' => 2, 'message' => 3, 'is_public' => 4, 'is_activated' => 5, 'created_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CommentPeer::IS_PUBLIC);
		$criteria->addSelectColumn(CommentPeer::IS_ACTIVATED);
